...
class FavouriteCategoriesActivity :
    ...
    override fun onItemLongClick(item: FavouriteCategory?, view: View): Boolean = item != null && selectionController.onItemLongClick(view, item.id)

    override fun onItemContextClick(item: FavouriteCategory?, view: View): Boolean = item != null && selectionController.onItemContextClick(view, item.id)
    ...
    private inner class ReorderHelperCallback :
        ...
        override fun getDragDirs(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder): Int = if (actionModeDelegate.isActionModeStarted) {
            0
        } else {
