...
class MangaStatsSheet :
    ...
    override fun onCreateViewBinding(inflater: LayoutInflater, container: ViewGroup?): SheetStatsMangaBinding = SheetStatsMangaBinding.inflate(inflater, container, false)
