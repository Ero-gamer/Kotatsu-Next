...
class ProtectSetupActivity :
    ...
    override fun onEditorAction(v: TextView?, actionId: Int, event: KeyEvent?): Boolean = if (actionId == EditorInfo.IME_ACTION_DONE && viewBinding.buttonNext.isEnabled) {
    ...
    private fun isBiometricAvailable(): Boolean = packageManager.hasSystemFeature(PackageManager.FEATURE_FINGERPRINT)
}
