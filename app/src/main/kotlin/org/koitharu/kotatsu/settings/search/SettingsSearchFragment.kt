...
class SettingsSearchFragment :
    ...
    override fun onCreateViewBinding(inflater: LayoutInflater, container: ViewGroup?): FragmentSearchSuggestionBinding = FragmentSearchSuggestionBinding.inflate(inflater, container, false)
