...
class DownloadsActivity :
    ...
    override fun onItemLongClick(item: DownloadItemModel, view: View): Boolean = selectionController.onItemLongClick(view, item.id.mostSignificantBits)

    override fun onItemContextClick(item: DownloadItemModel, view: View): Boolean = selectionController.onItemContextClick(view, item.id.mostSignificantBits)
