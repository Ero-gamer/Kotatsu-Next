...
class ScrobblingSelectorSheet :
    ...
    override fun onCreateViewBinding(inflater: LayoutInflater, container: ViewGroup?): SheetScrobblingSelectorBinding = SheetScrobblingSelectorBinding.inflate(inflater, container, false)
