...
abstract class MangaListFragment :
    ...
    override fun onItemLongClick(item: MangaListModel, view: View): Boolean = selectionController?.onItemLongClick(view, item.id) == true

    override fun onItemContextClick(item: MangaListModel, view: View): Boolean = selectionController?.onItemContextClick(view, item.id) == true
    ...
    protected open fun onCreateAdapter(): MangaListAdapter = MangaListAdapter(
        listener = this,
