...
class ExploreFragment :
    ...
    override fun onCreateViewBinding(inflater: LayoutInflater, container: ViewGroup?): FragmentExploreBinding = FragmentExploreBinding.inflate(inflater, container, false)
    ...
    override fun onItemLongClick(item: MangaSourceItem, view: View): Boolean = sourceSelectionController?.onItemLongClick(view, item.id) == true

    override fun onItemContextClick(item: MangaSourceItem, view: View): Boolean = sourceSelectionController?.onItemContextClick(view, item.id) == true
