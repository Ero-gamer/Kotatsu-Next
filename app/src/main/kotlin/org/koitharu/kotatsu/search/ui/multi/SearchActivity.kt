...
class SearchActivity :
    ...
    override fun onItemLongClick(item: MangaListModel, view: View): Boolean = selectionController.onItemLongClick(view, item.id)

    override fun onItemContextClick(item: MangaListModel, view: View): Boolean = selectionController.onItemContextClick(view, item.id)
