...
class SyncController @Inject constructor(
    ...
    fun isEnabled(account: Account): Boolean = ContentResolver.getMasterSyncAutomatically() && (
    ...
    fun isFavouritesEnabled(account: Account): Boolean = ContentResolver.getMasterSyncAutomatically() && ContentResolver.getSyncAutomatically(
        account,
        authorityFavourites,
    )

    fun isHistoryEnabled(account: Account): Boolean = ContentResolver.getMasterSyncAutomatically() && ContentResolver.getSyncAutomatically(
        account,
        authorityHistory,
    )
    ...
    private fun peekAccount(): Account? = am.getAccountsByType(accountType).firstOrNull()
