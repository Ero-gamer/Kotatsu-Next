...
class MangaLinkResolver @Inject constructor(
    ...
    suspend fun resolve(uri: Uri): Manga = if (uri.scheme == "kotatsu" || uri.host == "kotatsu.app") {
        resolveAppLink(uri)
    } else {
    ...
    companion object {
        ...
        fun isValidLink(str: String): Boolean = str.isHttpUrl() || str.startsWith("kotatsu://", ignoreCase = true)
    }
}
