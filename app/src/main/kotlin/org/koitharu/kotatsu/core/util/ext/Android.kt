...
fun Context.getAnimationDuration(@IntegerRes resId: Int): Long = (resources.getInteger(resId) * animatorDurationScale).roundToLong()
...
private fun PowerManager?.newPartialWakeLock(tag: String): PowerManager.WakeLock? = if (this != null && isWakeLockLevelSupported(PowerManager.PARTIAL_WAKE_LOCK)) {
