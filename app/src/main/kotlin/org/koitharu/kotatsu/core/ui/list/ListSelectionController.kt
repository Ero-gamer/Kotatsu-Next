...
class ListSelectionController(
    ...
    fun onItemLongClick(view: View, id: Long): Boolean = if (useActionMode) {
        startSelection(id)
    } else {
    ...
    override fun onCreateActionMode(mode: ActionMode, menu: Menu): Boolean = callback.onCreateActionMode(this, mode.menuInflater, menu)

    override fun onPrepareActionMode(mode: ActionMode, menu: Menu): Boolean = callback.onPrepareActionMode(this, mode, menu)

    override fun onActionItemClicked(mode: ActionMode, item: MenuItem): Boolean = callback.onActionItemClicked(this, mode, item)
