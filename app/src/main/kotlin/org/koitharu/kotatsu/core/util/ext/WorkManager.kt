...
@SuppressLint("RestrictedApi")
suspend fun WorkManager.awaitWorkInfoById(id: UUID): WorkInfo? = getWorkInfoById(id).await()

@SuppressLint("RestrictedApi")
suspend fun WorkManager.awaitUniqueWorkInfoByName(name: String): List<WorkInfo> = getWorkInfosForUniqueWork(name).await()
...
private val WorkManager.workManagerImpl
    @SuppressLint("RestrictedApi")
    inline get() = this as WorkManagerImpl
