...
class ChaptersPagesSheet :
    ...
    override fun onCreateViewBinding(inflater: LayoutInflater, container: ViewGroup?): SheetChaptersPagesBinding = SheetChaptersPagesBinding.inflate(inflater, container, false)
