...
class ChaptersFragment :
    ...
    override fun onItemLongClick(item: ChapterListItem, view: View): Boolean = selectionController?.onItemLongClick(view, item.chapter.id) == true

    override fun onItemContextClick(item: ChapterListItem, view: View): Boolean = selectionController?.onItemContextClick(view, item.chapter.id) == true
