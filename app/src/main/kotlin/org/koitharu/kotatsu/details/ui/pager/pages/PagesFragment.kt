...
class PagesFragment :
    ...
    override fun onCreateViewBinding(inflater: LayoutInflater, container: ViewGroup?): FragmentPagesBinding = FragmentPagesBinding.inflate(inflater, container, false)
    ...
    override fun onItemLongClick(item: PageThumbnail, view: View): Boolean = selectionController?.onItemLongClick(view, item.page.id) == true

    override fun onItemContextClick(item: PageThumbnail, view: View): Boolean = selectionController?.onItemContextClick(view, item.page.id) == true
