...
class BookmarksFragment :
    ...
    override fun onCreateViewBinding(inflater: LayoutInflater, container: ViewGroup?): FragmentMangaBookmarksBinding = FragmentMangaBookmarksBinding.inflate(inflater, container, false)
    ...
    override fun onItemLongClick(item: Bookmark, view: View): Boolean = selectionController?.onItemLongClick(view, item.pageId) == true

    override fun onItemContextClick(item: Bookmark, view: View): Boolean = selectionController?.onItemContextClick(view, item.pageId) == true
