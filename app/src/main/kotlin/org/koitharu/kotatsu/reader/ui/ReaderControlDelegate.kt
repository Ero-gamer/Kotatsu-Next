...
class ReaderControlDelegate(
    ...
    fun onKeyUp(keyCode: Int, @Suppress("UNUSED_PARAMETER") event: KeyEvent?): Boolean = (keyCode == KeyEvent.KEYCODE_VOLUME_DOWN || keyCode == KeyEvent.KEYCODE_VOLUME_UP) &&
    ...
    private fun switchByRelative(delta: Int, event: KeyEvent?) = switchBy(if (isReaderTapsReversed()) -delta else delta, event, scroll = false)
