...
abstract class BaseReaderFragment<B : ViewBinding> :
    BaseFragment<B>(),
    ...
    protected fun isAnimationEnabled(): Boolean = context?.isAnimationsEnabled == true && viewModel.pageAnimation.value != ReaderAnimation.NONE
