...
class ReaderInfoBarView @JvmOverloads constructor(
    ...
    override fun verifyDrawable(who: Drawable): Boolean = who == batteryIcon || super.verifyDrawable(who)
