...
class PageLoader @Inject constructor(
    ...
    suspend fun loadPage(page: MangaPage, force: Boolean): Uri = loadPageAsync(page, force).await()
    ...
    private suspend fun doConvertBitmap(uri: Uri): Uri = if (uri.isZipUri()) {
    ...
    private fun Deferred<Uri>.isValid(): Boolean = getCompletionResultOrNull()?.map { uri ->
