...
class LocalInfoDialog :
    ...
    override fun onCreateViewBinding(inflater: LayoutInflater, container: ViewGroup?): DialogLocalInfoBinding = DialogLocalInfoBinding.inflate(inflater, container, false)
