...
data class LocalManga(
    ...
    fun isMatchesQuery(query: String): Boolean = manga.title.contains(query, ignoreCase = true) ||
    ...
    private operator fun Collection<MangaTag>.contains(title: String): Boolean = any { it.title.equals(title, ignoreCase = true) }
