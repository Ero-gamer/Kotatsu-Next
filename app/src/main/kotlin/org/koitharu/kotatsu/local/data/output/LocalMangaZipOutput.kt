...
class LocalMangaZipOutput(
    ...
    override suspend fun addPage(chapter: IndexedValue<MangaChapter>, file: File, pageNumber: Int, type: MimeType?) = mutex.withLock {
        val name = buildString {
    ...
    companion object {
        ...
        suspend fun filterChapters(file: File, manga: Manga, idsToRemove: Set<Long>) = runInterruptible(Dispatchers.IO) {
