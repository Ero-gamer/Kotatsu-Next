...
open class CloudFlareActivity :
    ...
    fun shouldStayHiddenAndFocused(): Boolean = isAutoResolve && isHiddenPresentation && !isFinishing && !isDestroyed
    ...
    class Contract : ActivityResultContract<CloudFlareProtectedException, Boolean>() {
        override fun createIntent(context: Context, input: CloudFlareProtectedException): Intent = AppRouter.cloudFlareResolveIntent(context, input)
