...
**[Kotatsu Next](https://github.com/Ero-gamer/Kotatsu-Next) is a FOSS, lightweight and adfree manga/webtoon/manhua full featured reader app for Android based on [Kotatsu Redo](https://github.com/Kotatsu-Redo) with built-in
