...
**[Kotatsu Next](https://github.com/Ero-gamer/Kotatsu-Next) is a free and open-source manga/webtoon reader for Android based on [Kotatsu Redo](https://github.com/Kotatsu-Redo) with built-in
